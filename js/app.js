const PORTFOLIO_DATA = {
    ...
    "projects": [
        ...
        {
            "id": "crm-automation-ricepot",
            "title": "Enterprise CRM Automation (RICEPOT Method)",
            "description": "Enterprise-level Selenium automation framework for Free CRM using Java, Maven, and TestNG. Implements the RICEPOT method with ThreadLocal WebDriver for parallel execution and advanced Page Object Model architecture.",
            "tags": ["Java", "Selenium", "TestNG", "Automation", "POM"],
            "links": {
                "live": "#",
                "repo": "https://github.com/bhaumikgohel/POM-Framework-using-RICEPOT-Method"
            }
        },
        {
